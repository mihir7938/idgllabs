@if ($certificate)
    @if (preg_match('/[A-Za-z]/', $certificate->summary_no))
        <div class="print-container old-format">
            <h5 class="text-center mb-4">Diamond Report Summary</h5>
            <div class="row">
                <div class="col-lg-4">
            ...
            @if($certificate->description)
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        {!! html_entity_decode($certificate->description) !!}
                    </div>
                </div>
            @endif
            @if($shapes)
            ...
            @if($certificate->comment)
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        {!! html_entity_decode($certificate->comment) !!}
                    </div>
                </div>
            @endif
            @if($certificate->identification)
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        {!! html_entity_decode($certificate->identification) !!}
                    </div>
                </div>
            @endif
        </div>
